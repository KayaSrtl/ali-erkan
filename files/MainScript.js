...
function beReadyPage () {
	...
	$(".transition_sign").css("width", window_width); 
	...
	//$(".menu_main_cont").css("right", window_width/2 - parseInt($( ".menu_main_cont" ).css('width'))/2);
